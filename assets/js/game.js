...
var fight = function (enemyName) {
    while (playerHealth > 0 && enemyHealth > 0) {
        ...
        // remove enemy's health, by generating random attack value
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        ...
        if (playerHealth > 0) {
            ...
            if (playerHealth > 0 && i < enemyNames.length - 1) {
                //ask if player wants to visit shop
...
var shop = function () {
    ...
    //switch can carry out an action like an if
    switch (shopOptionPrompt) {
        ...
        default:
            ...
            // using shop() again will bring the shop interface back up
            shop();
            break;
    }
};
